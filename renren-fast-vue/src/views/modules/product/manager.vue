  ...
  <div class="mod-config">
    ...
    <el-table :data="dataList" border v-loading="dataListLoading" @selection-change="selectionChangeHandle" style="width: 100%;" @expand-change="getSkuDetails">
      ...
      <el-table-column prop="skuDefaultImg" header-align="center" align="center" label="默认图片">
        <template slot-scope="scope">
          <img :src="scope.row.skuDefaultImg == ''?baseUrl:scope.row.skuDefaultImg" style="width:80px;height:80px;" />
        </template>
      </el-table-column>
...
<script>
  ...
  export default {
    data() {
      return {
        baseUrl:
          'https://timechuchen-gulimall.oss-cn-hangzhou.aliyuncs.com/47de0f29f29bd73bb645eac370a9f452.jpeg',
        catPathSub: null,
        brandIdSub: null,
        dataForm: {
          key: '',
